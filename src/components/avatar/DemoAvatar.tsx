...
export function DemoAvatar({
  ...
  return (
    <div
      className={`${avatorBackground} ${avatorColor}  ${image ? "ring-1 ring-(--card-border)" : "ring-0"} w-full h-full rounded-full  shadow-(--shadow-card) flex justify-center items-center`}
    >
