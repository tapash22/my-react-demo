...
export function AccountDetailsCard() {
  ...
  return (
    <div className="flex justify-between items-center text-xs font-semibold text-(--foreground) opacity-70 w-full">
      <div className="flex justify-start items-center gap-3 w-2/3 h-auto ">
      ...
      <div className="flex justify-end items-center gap-2 p-2 space-y-1 w-1/3">
        <div className="flex flex-col items-center p-2 space-y-1">
          <button onClick={() => setShow(!show)}>llll</button>
