...
export function CategoryCard() {
  return (
    <div className="flex flex-col justify-between items-center text-xs font-semibold text-(--foreground) opacity-80 w-full ring-2 ring-(--input-border) p-3 rounded-xl">
      ...
      <div className="flex justify-end items-center gap-2 px-3 py-2 space-y-1 w-full">
